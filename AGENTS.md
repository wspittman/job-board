...
- `packages/cli`: Unified CLI for operational scripts, evals, and intermediate data collection.
- `packages/ops`: Legacy ops CLI for operational scripts against a running backend API instance.
- `packages/lab`: Legacy lab CLI for evals and intermediate data collection.
...
- `npm test`: Run tests for all workspaces that define tests (backend, frontend, lab, and cli).
