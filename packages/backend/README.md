...
| `DATABASE_MOCK_OPTIONS`                 | Optional inline JSON object keyed by container name to enable dry-utils-cosmosdb mocks.           |
| `DATABASE_MOCK_OPTIONS_PATH`            | Optional path to a JSON file containing mock options; merged with inline options when both set.   |
